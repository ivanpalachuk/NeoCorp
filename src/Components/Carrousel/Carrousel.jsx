...
const Carrousel = () => {
    ...
    return (
        <>
            <div className="mx-auto bottom-[198px] h-screen relative group z-0 shadow-md shadow-[#67c6e0] rounded-xl" id="inicio">
                {allImagesLoaded && (
                ...
                <div className="absolute top-[50%] font-[bankGothic] transform -translate-y-1/2 flex justify-center items-center  text-center inset-0 w-3/4 uppercase text-3xl mx-auto rounded-3xl p-2 bg-[#266f83]/60 h-[10%] text-white cursor-pointer">
                    {currentText}
                </div>
            </div>
        </>
